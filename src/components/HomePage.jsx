      ...
      <main className="mx-auto mt-32 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mt-6 text-xl text-gray-600 max-w-2xl mx-auto">
            Create your text, audio, and video in different languages in one
            stop!
          </p>
        ...
        <div className="mt-20 relative w-screen max-w-[150rem] -mx-4 px-2">
          <div className="relative">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, rgba(238, 235, 255, 0.1), rgba(238, 235, 255, 1))",
        ...
        <div
          id="features"
          className="mt-32 pb-16 bg-gradient-to-b from-purple-50/50"
        >
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="text-center mb-24">
              ...
              <p className="text-gray-600 text-xl">
                Discover Luga&apos;s cutting-edge features <br /> tailored for
                multimarket content creators and cross-border sellers.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white rounded-3xl p-8 text-left">
                <img
                  src="/generate_fluency.avif"
                  alt=""
                  className="w-full max-w-md aspect-[16/9] object-cover rounded-xl mb-6"
                />
                <h3 className="text-2xl font-medium mb-3">
                  New Idea for script?
                </h3>
                <p className="text-gray-600">
                  Luga utilises the best large language model to help you
                  generate fluency and ideas for content creation
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 text-left">
                ...
                />
                <h3 className="text-2xl font-medium mb-3">
                  Add A Voice To Your Text
                </h3>
                <p className="text-gray-600">
                  Clone your voice and use any customised human narratives
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 text-left">
                <img
                  src="/visual_interface.svg"
                  alt=""
                  className="w-full max-w-md aspect-[16/9] object-cover rounded-xl mb-6"
                />
                <h3 className="text-2xl font-medium mb-3">
                  Customise Your Visual Interface
                </h3>
                <p className="text-gray-600">
                  Upload any +1 min video of yours and lipsync in real-time
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 text-left">
                ...
                />
                <h3 className="text-2xl font-medium mb-3">
                  Use 24/7 AI Companions and Bots
                </h3>
                <p className="text-gray-600">
                  Design your own characters and let your AI agent to interact
                  with fans and customers on your behalf
                </p>
              </div>
            </div>
          </div>
        ...
        <div
          id="how-it-works"
          className="mt-16 pb-16 bg-gradient-to-b from-purple-50"
        >
          <div className="max-w-6xl mx-auto px-4 text-left">
            ...
            <div className="mb-24">
              ...
              <h2 className="text-4xl font-medium mb-4">
                Integrate Luga to your business
                <br />
                in 4 simple steps
              </h2>
            </div>
            ...
            <div className="flex flex-col space-y-20">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-medium mb-2">
                    4. You receive our deliverables
                  </h3>
                  <p className="text-gray-600">
                    Implementation and integration of your customized Luga AI
                    solution
                  </p>
                </div>
              </div>
